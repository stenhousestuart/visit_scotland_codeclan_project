...
### Annual Average Boxplots

```{r}
regional_domestic_tourism_all %>% 
  ggplot(aes(x = visits, y = region_of_residence)) +
  geom_boxplot(fill = "#540453", alpha = 0.5) +
  stat_summary(fun.y = mean, geom = "point", shape = 4, size = 5, color = "#1d1d65", fill="#1d1d65") +
  labs(
    title = "Distribution of Annual Number of Domestic Vistors",
    x = "Visits (Thousands)",
...
```{r}
regional_domestic_tourism_all %>% 
  ggplot(aes(x = expenditure, y = region_of_residence)) +
  geom_boxplot(fill = "#1d1d65", alpha = 0.5) +
  stat_summary(fun.y = mean, geom = "point", shape = 4, size = 5, color="#540453", fill="#540453") +
  labs(
    title = "Distribution of Average Annual Expenditure of Domestic Vistors",
    x = "Expenditure (Million GBP)",
    y = "Region of Residence",
    subtitle = "3 Year Averages")
```
...
regional_domestic_tourism_all %>%
  ...
  geom_line(group = 1, size = 1, colour = "#540453") +
  geom_point(colour = "#970061", show.legend = FALSE, size = 4) +
  labs(x = "\n Year Range",
